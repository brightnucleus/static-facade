...
use BrightNucleus\StaticFacade\Tests\StaticFacadeConsumer;
 ...
 * @author Alain Schlesser <alain.schlesser@gmail.com>
 */
class StaticFacadeTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @since 0.1.0
     */
    public function testCanForwardMethodCall()
    {
        $timestamp = StaticFacadeConsumer::getTimestamp();
     ...
     * @since 0.1.0
     */
    public function testThrowsExceptionOnMissingMethodCall()
    {
        $this->expectException(BadMethodCallException::class);
        $this->expectExceptionMessage('Great Scott!');
        StaticFacadeConsumer::unknownMethod();
    }
}
